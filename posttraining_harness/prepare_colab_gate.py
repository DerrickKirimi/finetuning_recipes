...
def main():
    ...
    names = ['pyproject.toml', 'uv.lock', 'README.md', 'check_env.sh',
             'posttraining_harness/hardware.py', 'posttraining_harness/assets.py', 'posttraining_harness/colab_gate.py']
    ...
    notebook['cells'].append(cell('code', '''
        command = [sys.executable, '-u', str(project / 'posttraining_harness/colab_gate.py'),
